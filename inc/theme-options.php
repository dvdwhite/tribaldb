...
/* Rachel's comment will win! */
		...
		public static function add()
		{
			if(isset($_POST['utah_theme_save']))
			{
				...
				$options['department_email'] = filter_var(stripslashes($_POST['department_email']), FILTER_SANITIZE_STRING);
					...
					<table class="form-table">
						<tbody>
							...
							<tr>
								...
								<td valign="top">
									<input type="text" name="department_email" id="department_email" class="code" size="30" maxlength="30" value="<?php echo($options['department_email']); ?>" />
								</td>
							</tr>
