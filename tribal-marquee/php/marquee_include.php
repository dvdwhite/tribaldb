		<?php
			$image_height = rwmb_meta( 'umc_meta_image_min_height_slider', $args = array(), $post_id = null );
			$full_screen = rwmb_meta( 'umc_meta_full_screen', $args = array(), $post_id = null );
			...
			echo '<div class="marquee">';
				echo '<div class="marquee_data">';
						$images = rwmb_meta( 'umc_meta_imgadv', 'type=image&size=full' );
						...
						{	
							...
							$image_heading = rwmb_meta( 'umc_image_meta_textarea_1', $args = array(), $image_id );
							$image_subhead = rwmb_meta( 'umc_image_meta_textarea_2', $args = array(), $image_id );
							$image_description_small = rwmb_meta( 'umc_image_meta_textarea_3', $args = array(), $image_id );
							$left_or_right = rwmb_meta( 'umc_image_meta_lr_radio', $args = array(), $image_id );
							$text_height = rwmb_meta( 'umc_image_meta_text_height_slider', $args = array(), $image_id );
							$link = rwmb_meta( 'umc_image_meta_url', $args = array(), $image_id );
							$large_image = wp_get_attachment_image_src( $image_id, 'large' );
							$image_url_large = $large_image[0];
							$vertical_position_class = rwmb_meta( 'umc_image_meta_vertical_position', $args = array(), $image_id );
