			 ...
			 <footer class="wrapper clearfix">
				...
				<?php wp_nav_menu( array( 
                    ...
                    <div class="footer-logo-container">
                        <div class="footer-logo"><a href="http://www.ojp.gov/" target="_blank"><img class="ojb" src="/wp-content/themes/tribaldb/images/global/logo-ojp.png" /></a></div>
                        <div class="footer-logo"><a href="http://www.ojjdp.gov/" target="_blank"><img class="ojjdp" src="/wp-content/themes/tribaldb/images/global/logo-ojjdb.png" /></a></div>
                        <div class="footer-logo"><a href="http://amberalert.gov" target="_blank"><img class="amber-alert" src="/wp-content/themes/tribaldb/images/global/logo-amber-alert.png" /></a></div>
                    </div>
					...
					<section class="brand-area clearfix">
							...
							<div class="spacer">
								...
								<div class="socons">
									...
									<ul class="umc-icon-list">
										...
										<?php } if ( !empty($themeOptions['instagram_url']) ) { ?>
											<li><a title="instagram" class="instagram-link" href="<?php echo $themeOptions['instagram_url']; ?>">instagram</a></li>	
										<?php } if ( !empty($themeOptions['linkedin_url']) ) { ?>
											<li><a title="linkedin" class="linkedin-link" href="<?php echo $themeOptions['linkedin_url']; ?>">linkedin</a></li>	
										<?php } ?>
									</ul>
						...
						<section class="address">
							<!--<div class="spacer">-->
								...
								<?php } if ( !empty($themeOptions['department_email']) ) {
									echo "<a href='mailto:" . $themeOptions['department_email'] . "'>" . $themeOptions['department_email'] . "</a>"; ?><br />
								<?php } ?>
								</p> 
								<p>
									&copy; <?php echo date("Y"); ?> The Tribal Database
								</p>
							<!--</div>-->
						</section>
					</section>
